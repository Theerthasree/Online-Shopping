<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usermanagement.aspx.cs" Inherits="E__Commerce_Shopping_Application.usermanagement" %>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EshoppingConnectionString %>" SelectCommand="SELECT * FROM [user_master]"></asp:SqlDataSource>
                        <hr>
                     </div>
                  </div>
                  <div class="row">
